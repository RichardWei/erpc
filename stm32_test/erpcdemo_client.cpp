...
binary_t * DEMO_client::RD_demoHello(const binary_t * txInput)
{
    ...
    {
        codec->startWriteMessage(message_type_t::kInvocationMessage, m_serviceId, m_RD_demoHelloId, request.getSequence());
    ...
    m_clientManager->callErrorHandler(err, m_RD_demoHelloId);
